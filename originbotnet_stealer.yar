rule OriginBotnet_XKeyBot
{
    ...
    condition:
        (uint16(0) == 0x5A4D) and
        (filesize > 10000 and filesize < 400000) and //05.02.24 - Added to reduce FP's, but expanded to include more samples.
        ( 1 of ($high_conf*) and 
        ( (1 of ($med_conf*) or (5 of ($low_conf_*))) ) ) //04.01.24 - Changed the logic for testing
}
